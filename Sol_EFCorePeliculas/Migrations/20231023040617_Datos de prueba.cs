    ...
    public partial class Datosdeprueba : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.InsertData(
                table: "Actores",
                columns: new[] { "Id", "Biografio", "FechaNacimiento", "Nombre" },
                values: new object[,]
                {
            ...
            migrationBuilder.InsertData(
                schema: "Peliculas",
                table: "TablaGeneros",
                columns: new[] { "Identificador", "NombreGenero" },
                values: new object[,]
                {
                    { 1, "Acción" },
                    { 2, "Animación" },
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, 1, new DateTime(2023, 10, 29, 0, 0, 0, 0, DateTimeKind.Local), new DateTime(2023, 10, 22, 0, 0, 0, 0, DateTimeKind.Local), 10m },
                    { 2, 4, new DateTime(2023, 10, 27, 0, 0, 0, 0, DateTimeKind.Local), new DateTime(2023, 10, 22, 0, 0, 0, 0, DateTimeKind.Local), 15m }
                });
