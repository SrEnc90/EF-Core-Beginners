...
namespace Sol_EFCorePeliculas.Migrations
{
    ...
    [Migration("20231023040617_Datos de prueba")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Sol_EFCorePeliculas.Entidades.Actor", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            Biografio = "Thomas Stanley Holland (Kingston upon Thames, Londres; 1 de junio de 1996), conocido simplemente como Tom Holland, es un actor, actor de voz y bailarín británico.",
                        ...
                        {
                            Id = 2,
                            Biografio = "Samuel Leroy Jackson (Washington D. C., 21 de diciembre de 1948), conocido como Samuel L. Jackson, es un actor y productor de cine, televisión y teatro estadounidense. Ha sido candidato al premio Óscar, a los Globos de Oro y al Premio del Sindicato de Actores, así como ganador de un BAFTA al mejor actor de reparto.",
                        ...
                        {
                            Id = 3,
                            Biografio = "Robert John Downey Jr. (Nueva York, 4 de abril de 1965) es un actor, actor de voz, productor y cantante estadounidense. Inició su carrera como actor a temprana edad apareciendo en varios filmes dirigidos por su padre, Robert Downey Sr., y en su infancia estudió actuación en varias academias de Nueva York.",
            ...
            modelBuilder.Entity("Sol_EFCorePeliculas.Entidades.CineOferta", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 2,
                            CineId = 4,
                            FechaFin = new DateTime(2023, 10, 27, 0, 0, 0, 0, DateTimeKind.Local),
                            FechaInicio = new DateTime(2023, 10, 22, 0, 0, 0, 0, DateTimeKind.Local),
                        ...
                        new
                        {
                            Id = 1,
                            CineId = 1,
                            FechaFin = new DateTime(2023, 10, 29, 0, 0, 0, 0, DateTimeKind.Local),
                            FechaInicio = new DateTime(2023, 10, 22, 0, 0, 0, 0, DateTimeKind.Local),
            ...
            modelBuilder.Entity("Sol_EFCorePeliculas.Entidades.PeliculaActor", b =>
                {
            ...
            modelBuilder.Entity("Sol_EFCorePeliculas.Entidades.PeliculaActor", b =>
                {
                    b.HasOne("Sol_EFCorePeliculas.Entidades.Actor", "Actor")
                        .WithOne("PeliculasActores")
                        .HasForeignKey("Sol_EFCorePeliculas.Entidades.PeliculaActor", "ActorId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Sol_EFCorePeliculas.Entidades.Pelicula", "Pelicula")
